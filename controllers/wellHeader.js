...
module.exports = {
    TOP : new WellHeader('Top_depth', 'STRT', 'Top Depth'),
    STOP : new WellHeader('Bottom_depth', 'STOP', 'Bottom Depth'),
    STEP : new WellHeader('Step', 'STEP', 'Step'),
    NULL : new WellHeader('Null_value', 'NULL', 'Null value'),
    ...
    EASTING : new WellHeader('Easting_(X)', 'E', 'Easting (X)'),
    NORTHING : new WellHeader('Northing_(Y)', 'N', 'Northing (y)'),
